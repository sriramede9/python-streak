...
df['point_tier']=pd.cut(df.points,labels=['Low','Medium','High'],bins=bins_list,precision=3)
...
df[(df.designation.str.contains(pat="Reserve",case=False)|df.designation.str.contains(pat="Selection",case=False))]
